  ...
  return (
    <Container>
      {challengeDetail.map((challenge) => (
        <ChallengeDetailCard title={challenge.title} start_day={challenge.start_day} duration={challenge.duration} frequency={challenge.frequency} max_member={challenge.max_member}/>
      ))}
    </Container>
  );
};
